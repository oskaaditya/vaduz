...
var model = document.getElementById("castle");
AFRAME.registerComponent('model-viewer', {
  ...
  init: function () {
    ...
    var model = document.getElementById("castle");
    model.addEventListener('model-loaded', this.onModelLoaded);
  },
  ...
  initCameraRig: function () {
    ...
    rightHandEl.setAttribute('raycaster', {objects: '.clickable'});
    ...
    leftHandEl.setAttribute('raycaster', {objects: '.clickable'});
  ...
  initEntities: function () {
    ...
    laserHitPanelEl.classList.add('clickable');
  ...
  onThumbstickMoved: function (evt) {
    ...
    {
    var modelPivotEl = document.getElementById("castle");
  ...
  onMouseWheel: function (evt) {
    ...
    var modelPivotEl = document.getElementById("castle");
    var modelScale = this.modelScale || modelPivotEl.object3D.scale.x;
    modelScale -= evt.deltaY / 10000;
    modelScale = Math.min(Math.max(0.6, modelScale), 2.0);
    // Clamp scale.
    modelPivotEl.object3D.scale.set(modelScale, modelScale, modelScale);
    this.modelScale = modelScale;
    }
  ...
  centerAndScaleModel: function () {
    ...
    var center;
    var scale;
    var modelEl = document.getElementById("castle")
